        ...
        <figure className='grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10'>
          <div className='relative col-span-2 lg:col-start-1 lg:row-start-2'>
            ...
            <blockquote className='text-xl font-semibold leading-8 text-gray-900 sm:text-2xl sm:leading-9'>
              <p>
                {APP_NAME} helps me track my spending and stay on top of my
                finances. Thanks {APP_NAME}!
              </p>
            </blockquote>
          </div>
          <div className='col-end-1 w-16 lg:row-span-4 lg:w-32'>
            <img
              className='rounded-xl bg-indigo-50 lg:rounded-3xl'
              src='https://avatars.githubusercontent.com/u/59413856?v=4'
              alt=''
            />
          </div>
          <figcaption className='text-base lg:col-start-1 lg:row-start-3'>
            <div className='font-semibold text-gray-900'>Deborah Ong</div>
            <div className='mt-1 text-gray-500'>Software Engineer</div>
          </figcaption>
        </figure>
      </div>
    </section>
