...
//       onHide={onHide}
//     >
//       <div className='max-sm:pb-6 sm:flex sm:items-start'>
//         <form
...
//               <select
//                 id='category'
//                 className='border-input bg-background placeholder:text-muted-foreground focus-visible:ring-ring mt-1.5 flex h-9 w-full rounded-md border px-3 py-1 text-sm shadow-sm focus-visible:outline-none focus-visible:ring-1 max-sm:h-10'
//                 onChange={(event) => {
